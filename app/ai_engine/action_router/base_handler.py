...
class BaseHandler(ABC):
    ...
    def __init__(self, action_router):
        ...
        self.conversation = action_router.conversation
        self.formatter = action_router.formatter
        # decision_support is not an attribute of ActionRouter, remove it
    
    # No abstract method - handlers implement their own specific methods
